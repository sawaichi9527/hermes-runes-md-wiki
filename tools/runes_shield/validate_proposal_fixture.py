...
# Source: dev/tools/runes_shield/validation/validate_proposal_fixture.py
# Copied for runtime self-containment (tools/runes_shield must not depend on dev/).
# Keep in sync with the dev source when updating the validator.
# See DEPENDENCY_NOTES.md in this directory for the full source mapping.

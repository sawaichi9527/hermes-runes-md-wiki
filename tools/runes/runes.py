...
def build_parser() -> argparse.ArgumentParser:
    ...
    propose.add_argument("--project", default="freelancer")
    ...
    promotion_preview.add_argument("--project", default="freelancer")
    ...
    promotion_preflight.add_argument("--project", default="freelancer")
    ...
    promotion_rollback.add_argument("--project", default="freelancer")
    ...
    attunement_trail.add_argument("--project", default="freelancer")
    ...
    proposal_list.add_argument("--project", default="freelancer")
    ...
    proposal_show.add_argument("--project", default="freelancer")
    ...
    proposal_hygiene.add_argument("--project", default="freelancer")
